...
##### 家长辅助：
> 除了带宝藏的格子（比如5），在1-30每个格子里面填上数学题目，注意带陷阱的格子（如3）和带飓风的格子（如7）可适当加大难度。

*请注意25格和26格不连贯，不影响游戏，仍然是按格子数字顺序行进。*

##### 游戏规则：
1. 玩家从起点START开始
1. 每一次掷骰子决定可由当前位置P0抵达的格子P1
1. 如果P1是宝藏格，安全停在P1
1. 如果P1是蓝色格或者陷阱格，需答对数学题才能留在P1，否则返回之前的位置P0；如果P1的问题已经被解答，则无需解题，安全停在P1
